package space.kingdragonfly.jhipster.application;

import space.kingdragonfly.jhipster.application.config.ApplicationProperties;
import space.kingdragonfly.jhipster.application.config.DefaultProfileUtil;
