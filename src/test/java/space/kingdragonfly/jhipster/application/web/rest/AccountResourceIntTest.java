package space.kingdragonfly.jhipster.application.web.rest;

import space.kingdragonfly.jhipster.application.config.Constants;
import space.kingdragonfly.jhipster.application.JhipsterSampleApplicationApp;
import space.kingdragonfly.jhipster.application.domain.Authority;
import space.kingdragonfly.jhipster.application.domain.PersistentToken;
import space.kingdragonfly.jhipster.application.domain.User;
import space.kingdragonfly.jhipster.application.repository.AuthorityRepository;
import space.kingdragonfly.jhipster.application.repository.PersistentTokenRepository;
import space.kingdragonfly.jhipster.application.repository.UserRepository;
import space.kingdragonfly.jhipster.application.security.AuthoritiesConstants;
import space.kingdragonfly.jhipster.application.service.MailService;
import space.kingdragonfly.jhipster.application.service.dto.UserDTO;
import space.kingdragonfly.jhipster.application.web.rest.errors.ExceptionTranslator;
import space.kingdragonfly.jhipster.application.web.rest.vm.KeyAndPasswordVM;
import space.kingdragonfly.jhipster.application.web.rest.vm.ManagedUserVM;
import space.kingdragonfly.jhipster.application.service.UserService;
